...
| :---------------------- | :---------------------- | :---------------------- |
| [Многоцелевая модель для NER + event-CLS](ner) | Cозданию многоцелевой модели для NER-разметки новостных текстов и выделением тэгов о содержимой информации.| *torch*, *transformers*, *datasets*, *matplotlib*, *BERT*|
| [Обучение собственной LLM](llm) | Обучение LLM (в ходе проекта рассмотрены два первые этапа обучения LLM: pretrain и SFT)| *torch*, *tokenizers*, *transformers*, *datasets*, *trl*, *LLM*|
