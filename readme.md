...
| :---------------------- | :---------------------- | :---------------------- |
| [Многоцелевая модель для NER + event-CLS](ner) | Cоздание многоцелевой модели (на базе BERTа) для NER-разметки новостных текстов и выделением тэгов о содержимой информации.| *torch*, *transformers*, *datasets*, *matplotlib*|
...
| [Детекция объектов](detection) | Проект по дообучение моделей для детекции мобов кубического мира (YOLO и FCOS).  | *torch*,*mmdet*, *ultralytics*, *cv2*, *matplotlib*, *fpdf*|
