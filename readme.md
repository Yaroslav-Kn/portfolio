...
| [Даги Airflow для DWH на нескольких источниках данных](dwh_order_deliveries) | Разработка дагов Airflow для создания и наполнения DWH на нескольких источниках данных (PostgreSQL, Mongo-DB, API)| *Airflow*, *SQL*, *NoSQL*, *requests*, *psycopg*|