...
| Название проекта | Описание | Используемые библиотеки | 
| :---------------------- | :---------------------- | :---------------------- |
| [Создание рекомендательной системы товаров в электронной комерции](rec_sys_ec) | Создание рекомендательной системы и микросервиса на её основе, а также системы мониторинга| *pandas*, *matplotlib*, *catboost*, *FastAPI*, *Docker*, *Airflow*, *MLflow*, *prometheus*, *grafana*|
