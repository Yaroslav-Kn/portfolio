CREATE TABLE IF NOT EXISTS dds.fct_product_sales (
	...
	CONSTRAINT fct_product_sales_order_id_ref FOREIGN KEY (order_id) REFERENCES dds.dm_orders(id),
	CONSTRAINT fct_product_sales_product_id_ref FOREIGN KEY (product_id) REFERENCES dds.dm_products(id)
);
