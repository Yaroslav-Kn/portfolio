...
class OrderLoader:
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_orders(last_loaded_ts, 'orders', self._SESSION_LIMIT)
            ...
            i = 0
            for d in load_queue:
                self.pg_saver.save_object(conn, str(d["_id"]), d["update_ts"], d, 'ordersystem_orders')
